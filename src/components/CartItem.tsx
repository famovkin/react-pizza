  ...
  return (
    <div className="cart-item cart__cart-item">
      ...
      <div className="cart-item__count">
        ...
        <b className="cart-item__counter">{totalCount}</b>
        <Button onClick={onPlus} outline circle>
          <svg
            width="10"
            height="10"
            viewBox="0 0 10 10"
      ...
      <div className="cart-item__price">
        <b>
          {totalPrice} <span className="rub">P</span>
        </b>
      </div>
      <div className="cart-item__remove">
        <Button onClick={onDeleteCartItem} outline circle>
          <svg
            width="10"
            height="10"
            viewBox="0 0 10 10"
