...
function Cart() {
  ...
  const handleMinusClick = (id) => dispatch(minusCartItem(id));
        ...
        <div className="cart content__cart">
          <div className="cart__header">
            ...
            <div className="cart__clear">
              ...
              <span className="cart__clear-button" onClick={handleClearCart}>
                Очистить корзину
              </span>
            </div>
          </div>
          ...
          <div className="cart__checkout">
            <div className="cart__checkout-details">
              ...
              <span>
                Сумма заказа:{" "}
                <b>
                  {totalPrice} <span className="rub rub_type_orange">P</span>
                </b>
              </span>
            </div>
